...
class CompanySpec extends Specification {
  ...
  @Unroll
  void """When we have a company with name: #name, description: #description, web: #web, logoPath: #logoPath, corporatePress: #corporatePress, notes: #notes, tags: #tags, we expect the result is: #result"""() {
  given: "A company"
  ...
  when: "We assign values to command"
    ...
    company.corporatePress = corporatePress
    company.notes = notes
    company.tags = tags
    company.type = type
   ...
   name          | description | web                           | logoPath                               | corporatePress                         | notes   | tags   | type                   || result
