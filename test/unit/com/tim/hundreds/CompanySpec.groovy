...
class CompanySpec extends Specification {
  ...
  @Unroll
  void """When we have a company with name: #name, description: #description, web: #web, logo: #logo, corporatePress: #corporatePress, notes: #notes, tags: #tags, we expect the result is: #result"""() {
  given: "A company"
  ...
  when: "We assign values to command"
   ...
   name          | description | web                           | logo                                   | corporatePress                         | notes   | tags   | type                   || result
