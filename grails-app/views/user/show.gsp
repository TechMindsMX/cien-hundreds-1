		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<g:if test="${userInstance?.profile?.firstName}">
				<li class="fieldcontain">
					<span id="firstName-label" class="${session.labelWidth} property-label"><g:message code="user.firstName.label" default="firstName" /></span>
			...
			<g:if test="${userInstance?.profile?.lastName}">
				<li class="fieldcontain">
					<span id="lastName-label" class="${session.labelWidth} property-label"><g:message code="user.lastName.label" default="lastName" /></span>
			...
			<g:if test="${userInstance?.profile?.email}">
				<li class="fieldcontain">
					<span id="email-label" class="${session.labelWidth} property-label"><g:message code="user.email.label" default="email" /></span>
			...
			<g:if test="${userInstance?.profile?.phone}">
				<li class="fieldcontain">
					<span id="phone-label" class="${session.labelWidth} property-label"><g:message code="user.phone.label" default="phone" /></span>
