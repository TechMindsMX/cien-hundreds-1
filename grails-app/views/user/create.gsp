                        ...
                        <table class="table">
                            ...
                            <tbody class="borderless">
                                <tr>
                                    ...
                                    <td>
                                        <g:textField name="profile.firstName" class="form-control" placeholder="Ingrese su(s) nombre(s)" size="60" />
                                        <br>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <g:textField name="profile.middleName" class="form-control" placeholder="Ingrese su apellido paterno" />
                                        <br>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <g:textField name="profile.lastName" class="form-control" placeholder="Ingrese su apellido materno" />
                                        <br>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <g:textField name="profile.phone" class="form-control" placeholder="Ingrese su número telefónico (10 dígitos)" />
                                        <br>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <g:textField name="profile.email" class="form-control" placeholder="Ingrese su correo electrónico" />
                                        <br>
                                    </td>
                                </tr>
                                <tr>
