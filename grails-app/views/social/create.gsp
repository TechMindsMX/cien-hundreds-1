...
<html>
	...
	<body>
		<a href="#create-social" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-social" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:socialInstance, action:'save']" class="form-horizontal" >
				<fieldset class="form">
