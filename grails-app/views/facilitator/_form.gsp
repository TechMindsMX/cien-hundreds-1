...
<div class="form-group fieldcontain ${hasErrors(bean: model, field: 'username', 'error')} required">
    <label class="${session.labelWidth} control-label" for="username"><g:message code="facilitator.username.label" default="Usuario"/></label>
...
<div class="form-group fieldcontain ${hasErrors(bean: model, field: 'password', 'error')} required">
    <label class="${session.labelWidth} control-label" for="password"><g:message code="facilitator.password.label" default="Contraseña"/></label>
...
<div class="form-group fieldcontain ${hasErrors(bean: model, field: 'passwordCheck', 'error')} required">
    <label class="${session.labelWidth} control-label" for="passwordCheck"><g:message code="facilitator.passwordCheck.label" default="Confirme su contraseña"/></label>
...
<div class="form-group fieldcontain ${hasErrors(bean: model, field: 'firstName', 'error')} required">
    <label class="${session.labelWidth} control-label" for="firstName"><g:message code="firstName.label" default="Nombre(s)"/></label>
...
<div class="form-group fieldcontain ${hasErrors(bean: model, field: 'middleName', 'error')} required">
    <label class="${session.labelWidth} control-label" for="middleName"><g:message code="middleName.label" default="Apellido paterno"/></label>
...
<div class="form-group fieldcontain ${hasErrors(bean: model, field: 'lastName', 'error')} required">
    <label class="${session.labelWidth} control-label" for="lastName"><g:message code="lastName.label" default="Apellido materno"/></label>
...
<div class="form-group fieldcontain ${hasErrors(bean: model, field: 'email', 'error')} required">
    <label class="${session.labelWidth} control-label" for="email"><g:message code="email.label" default="Correo electrónico"/></label>
...
<div class="form-group fieldcontain ${hasErrors(bean: model, field: 'emailCheck', 'error')} required">
    <label class="${session.labelWidth} control-label" for="emailCheck"><g:message code="facilitator.emailCheck.label" default="Confirme su correo electrónico"/></label>
