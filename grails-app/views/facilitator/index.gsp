    ...
    <body>
        ...
        <div class="container theme-showcase">
            ...
            <div class="page-header">
                ...
                <p>Por favor ingrese los datos de este formulario par crear un Facilitador o un Comprador en la plataforma 100  Hundreds</p>
            </div>
                            ...
                            <tbody class="borderless">
                                ...
                                <tr>
                                    ...
                                    <td style="display: table-cell;">
                                        ...
                                        <div>                                            
                                            <g:submitButton name="create" placeholder="Enviar" class="btn btn-success " />
