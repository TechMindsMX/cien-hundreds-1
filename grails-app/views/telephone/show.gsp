		...
		<div id="show-telephone" class="content scaffold-show" role="main">
			...
			<ul class="property-list telephone">
				...
				<li class="fieldcontain">
					...
					<span class="property-value" aria-labelledby="contact-label"><g:link controller="contact" action="show" id="${telephoneInstance?.contact?.id}">${telephoneInstance?.contact?.firstName.encodeAsHTML()} ${telephoneInstance?.contact?.lastName.encodeAsHTML()}</g:link></span>
				</li>
				</g:if>
