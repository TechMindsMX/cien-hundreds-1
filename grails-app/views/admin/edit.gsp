...
<html>
  ...
  <body>
    ...
    <div id="edit-user" class="content scaffold-edit" role="main">
      ...
      <g:eachError bean="${model}">
        <li class="alert alert-danger"><g:message error="${it}" /></li>
      </g:eachError>
      <g:uploadForm url="[resource:userInstance, action:'update']" method="POST"  class="form-horizontal">
