			...
			<ol class="property-list activity">
				...
				<li class="fieldcontain">
					<span id="musician-label" class="property-label"><g:message code="activity.musician.label" default="Musician" /></span>
						...
						<span class="property-value" aria-labelledby="musician-label"><g:link controller="musician" action="show" id="${activityInstance?.musician?.id}">${activityInstance?.musician?.encodeAsHTML()}</g:link></span>
