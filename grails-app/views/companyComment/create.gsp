...
<html>
	...
	<body>
		<a href="#create-companyComment" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-companyComment" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:companyCommentInstance, action:'save']"  class="form-horizontal">
				<fieldset class="form">
