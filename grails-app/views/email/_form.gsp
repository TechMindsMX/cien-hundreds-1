...
<div class="form-group fieldcontain ${hasErrors(bean: emailInstance, field: 'address', 'error')} required">
	...
	<div class="${session.inputWidth}">
		<g:field class="form-control" type="email" name="address" maxlength="200" required="" value="${emailInstance?.address}"/>
	</div>
</div>
...
<g:hiddenField name="contact.id" value="${params?.contactId}" />
