...
<div class="form-group fieldcontain ${hasErrors(bean: collaboratorInstance, field: 'emails', 'error')} ">
...
<div class="form-group fieldcontain ${hasErrors(bean: collaboratorInstance, field: 'telephones', 'error')} ">
