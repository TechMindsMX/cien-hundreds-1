	...
	<body>
		...
		<div id="show-collaborator" class="content scaffold-show" role="main">
			...
			<ul class="property-list collaborator">
				...
				<g:if test="${collaboratorInstance?.uuid}">
				<li class="fieldcontain">
					<span id="uuid-label" class="${session.labelWidth} property-label"><g:message code="collaborator.uuid.label" default="Uuid" /></span>
					
						<span class="property-value" aria-labelledby="uuid-label"><g:fieldValue bean="${collaboratorInstance}" field="uuid"/></span>
