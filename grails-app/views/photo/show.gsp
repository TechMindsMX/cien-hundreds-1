			...
			<ol class="property-list photo">
				...
				<li class="fieldcontain">
					<span id="musician-label" class="property-label"><g:message code="photo.musician.label" default="Musician" /></span>
						...
						<span class="property-value" aria-labelledby="musician-label"><g:link controller="musician" action="show" id="${photoInstance?.musician?.id}">${photoInstance?.musician?.encodeAsHTML()}</g:link></span>
