...
<div class="form-group fieldcontain ${hasErrors(bean: contactInstance, field: 'birthDate', 'error')} required">
	...
	<div class="${session.inputWidth}">
		<g:timDatePicker name="birthDate" minDate="-10Y" maxDate="-0D" value="${contactInstance?.birthDate}"></g:timDatePicker>
	</div>
</div>
...
<div class="form-group fieldcontain ${hasErrors(bean: contactInstance, field: 'entryDate', 'error')} required" relativeYears="[-100..0]">
	...
	<div class="${session.inputWidth}">
		<g:timDatePicker name="entryDate" minDate="-10Y" maxDate="-0D" value="${contactInstance?.entryDate}"></g:timDatePicker>
	</div>
</div>
